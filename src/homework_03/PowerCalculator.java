 ...
 * Если введены некорректные числа или происходит ошибка ввода, соответствующие исключения перехватываются
 * и выводится информативное сообщение об ошибке.
...
public class PowerCalculator {
    ...
    public static double calculatePower(double num1, double num2) throws InvalidInputException{
        if (num1 == 0) throw new InvalidInputException("Число не должно быть равным нулю!");
